...
namespace Adventure.Web.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var modelProducts = Mapper.Map<List<Master>, List<MasterModel>>(products.ToList());

            modelHeader.purchasedetailmodel = modelDetail;
            modelHeader.VendorList = new SelectList(purcService.GetVendors(), "BusinessEntityID", "Name");
            modelHeader.ShipMethodList = new SelectList(purcService.GetShipMethods(), "ShipMethodID", "Name");
            //header.VendorID = header.VendorList.Select();
            ViewBag.Title = "Edit";
